...
public class TrackingSpaceGenerator
{
    ...
    public static void GenerateRectangleTrackingSpace(int obstacleType, out List<Vector2> trackingSpacePoints, out List<List<Vector2>> obstaclePolygons, out List<InitialConfiguration> initialConfigurations, float width,float height)
    {
        ...
        //    }
        foreach (var x in new float[] { 0, 0 })
            foreach (var y in new float[] { 0, 0 })
            {
                initialConfigurations.Add(new InitialConfiguration(new Vector2(x, y), new Vector2(0, 1).normalized));
            }
        float positionY = 0;
        switch (obstacleType) {
            case 0:
            ...
            case 4:
                ...
                obstaclePolygons.Add(new List<Vector2>
                {
                    new Vector2(2,distToWall + 4),
                    new Vector2(-2,distToWall + 4),
                    new Vector2(-2,distToWall),
                    new Vector2(2,distToWall),
                });
                trackingSpacePoints = new List<Vector2> {
                new Vector2(width/2, height - distToWall),
                new Vector2(-width/2, height-distToWall),
                new Vector2(-width/2, -distToWall),
                new Vector2(width/2, -distToWall),
                };
                //distToWall = 1.5f;
                //float obstacleWidth = 3;
                //obstaclePolygons.Add(new List<Vector2> {
                //    new Vector2(obstacleWidth/2,obstacleWidth/2),
                //    new Vector2(-obstacleWidth/2, obstacleWidth/2),
                //    new Vector2(-obstacleWidth/2, -obstacleWidth/2),
                //    new Vector2(obstacleWidth/2, -obstacleWidth/2),
                //});
                ...
                //    new Vector2(width/2 ,-height/2),
                //};
                //positionY = (-obstacleWidth / 2 - height / 2) / 2;
                //initialConfigurations = new List<InitialConfiguration>();
                //initialConfigurations.Add(new InitialConfiguration(new Vector2(0, positionY), Vector2.up));
                //break;
                break;
            case 5:
                obstaclePolygons.Add(new List<Vector2> {
                    new Vector2(-width/2 + 1, height/2 + 1),
                    new Vector2(-(width * 3 / 2), height/2 + 1),
                    new Vector2(-(width * 3 / 2),-height/2 + 1),
                    new Vector2(-width/2 + 1,-height/2 + 1),
                });
                trackingSpacePoints = new List<Vector2> {
                    new Vector2(width/2, height * 3 / 2 + 1),
                    new Vector2(-(width * 3 / 2), height * 3 / 2 + 1),
                    new Vector2(-(width * 3 / 2), -(height / 2) +1),
            ...
            case 6:
                ...
                obstaclePolygons.Add(new List<Vector2>
                {
                    new Vector2(width/2,width/2 + 3),
                    new Vector2(+1,width/2 + 3),
                    new Vector2(1,3),
                    new Vector2(width/2,3),
                });
                obstaclePolygons.Add(new List<Vector2>
                {
                    new Vector2(-1, width/4 + 2),
                    new Vector2(-width/2, width/4 + 2),
                ...
                break;
            case 7:
                // sqaure tracking space with low starting point
                //trackingSpacePoints = new List<Vector2> {
                //    new Vector2(4, 7),
                //    new Vector2(-4,7),
                //    new Vector2(-4,-1),
            ...
            case 8:
                trackingSpacePoints = new List<Vector2>
                {
                    new Vector2(+1.5f, width - 3.5f),
                    new Vector2(-width + 1.5f, width - 3.5f),
                    new Vector2(-width + 1.5f,-3.5f),
